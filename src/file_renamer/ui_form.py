...
from PySide6.QtWidgets import (
    QApplication, QCheckBox, QComboBox, QGridLayout, QGroupBox, QLabel,
    QLineEdit, QPushButton, QSizePolicy, QTextEdit, QWidget
    )
...
class Ui_Widget(object):
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(
            QCoreApplication.translate("Widget", u"File Renamer", None))
        self.label.setText(
            QCoreApplication.translate("Widget", u"PREVIEW", None))
        self.browse.setTitle("")
        self.dir_btn.setText(
            QCoreApplication.translate("Widget", u"Browse", None))
        self.options.setTitle("")
        self.recursively.setText(
        ...
        self.extension.setText(
            QCoreApplication.translate("Widget", u"Keep Extension", None))
        self.groupBox.setTitle("")
        self.comboBox.setItemText(
            0, QCoreApplication.translate("Widget", u"Select", None))
        self.comboBox.setItemText(
        ...
        self.comboBox.setItemText(
            8, QCoreApplication.translate("Widget", u"Title Case", None))
        self.comboBox.setItemText(
            9, QCoreApplication.translate(
                "Widget", u"Remove ID", None))
        self.comboBox.setItemText(
            10, QCoreApplication.translate("Widget", u"Number", None))

        self.clear_btn.setText(
            QCoreApplication.translate("Widget", u"CLEAR", None))
        self.rename_btn.setText(
            QCoreApplication.translate("Widget", u"RENAME", None))
        self.search_replace.setTitle("")
        self.search_label.setText(
            QCoreApplication.translate("Widget", u"Search", None))
        self.replace_label.setText(
            QCoreApplication.translate("Widget", u"Replace", None))
        self.replace.setText("")
        self.regex.setText(
            QCoreApplication.translate("Widget", u"Regular Expression", None))
        self.find_btn.setText(
            QCoreApplication.translate("Widget", u"Find", None))
    # retranslateUi
